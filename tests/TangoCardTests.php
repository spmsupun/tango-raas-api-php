<?php
use Integrateideas\TangoRaasApi\TangoCard As TangoCard;
...
class TangoCardTests extends PHPUnit_Framework_TestCase{
	...
	public function setup(){
		$this->tango=new TangoCard("QAPlatform2","apYPfT6HNONpDRUj3CLGWYt7gvIHONpDRUYPfT6Hj");
	...
	/**
	* @expectedException Integrateideas\TangoCardAppModeInvalidException
	*/
